...
public class ExpandableListAdapter extends BaseExpandableListAdapter {
    ...
    private List<Menu> _listDataHeader; // header titles
    // child data in format of header title, child title
    private HashMap<Menu, List<String>> _listDataChild;

    public ExpandableListAdapter(Context context, List<Menu> listDataHeader,
                                 HashMap<Menu, List<String>> listChildData) {
